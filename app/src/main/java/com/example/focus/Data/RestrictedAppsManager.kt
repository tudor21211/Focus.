...
object RestrictedAppsManager {
    private val listOfRestrictedApps = mutableListOf<String>() //ASTA POATE FI FACUTA CU ROOMS DATABASE SA RETIN APLICATIILE BLOCATE INTR-UN DB SI SA LE FAC ADD / REMOVE
